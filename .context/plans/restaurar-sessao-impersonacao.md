---
id: plan-restaurar-sessao-impersonacao
ai_update_goal: "Define the stages, owners, and evidence required to complete Restaurar Sessão Admin ao Encerrar Impersonação."
required_inputs:
...
<!-- agent-update:start:plan-restaurar-sessao-impersonacao -->
# Restaurar Sessão Admin ao Encerrar Impersonação Plan

> Implementar funcionalidade para restaurar automaticamente a sessão do admin original ao encerrar uma impersonação, em vez de fazer logout e redirecionar para login.
